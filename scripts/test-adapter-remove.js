...
// Set the vault_address in chain-137 which should remove testAdapter
...
const main = async () => {
    ...
    const { "0": adapterArray, "1": adapterIdentifier } = await exchangeAggregator.getExchangeAdapters();
